...
ifeq ($(config),debug_x64)
  ...
  TARGETDIR = ../../../bin/vst2
  TARGET = $(TARGETDIR)/squeezer_vst2_sidechain_debug_x64.so
  ...
  LIBS += -ldl -lfreetype -lpthread -lrt -lX11 -lXext
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -shared -Wl,-soname=squeezer_vst2_sidechain_debug_x64.so -Wl,--no-undefined
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
