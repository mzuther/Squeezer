...

{
    ...
    case GenericMeterOrientation::vertical:
        ...
        // initialise drawing points
        pos_1 = math::Simple::round(maximumY_ * levelPosition);
    ...
    case GenericMeterOrientation::horizontalInverted:
        ...
        // initialise drawing points
        pos_1 = math::Simple::round(maximumX_ * levelPosition);
...

{
    ...
    case GenericMeterOrientation::vertical:
        ...
        // initialise drawing points
        pos_1 = math::Simple::roundDown((maximumY_ + 1) * levelPosition);
    ...
    case GenericMeterOrientation::horizontalInverted:
        ...
        // initialise drawing points
        pos_1 = math::Simple::roundDown((maximumX_ + 1) * levelPosition);
