...
have invested a lot of time to fine-tune these presets and ensure that
...
Depending on your action, Squeezer tries to preserve your current
...
\item Curve shape buttons
\item RMS button
\item Opto button
\item Knee width buttons
